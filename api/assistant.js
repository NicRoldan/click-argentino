...
module.exports = async (req, res) => {
  ...
  if (!OPENAI_API_KEY || !ASSISTANT_ID) {
    ...
    sendJson(res, 500, { error: "Server misconfigured: Missing API key or Assistant ID (ASSISTANT_ID or OPENAI_ASSISTANT_ID). Please configure environment variables in Vercel." });
    return;
  }
